...
typedef struct
{
    ...
    uint32_t freqTmrClk;
    uint32_t freqUART;
    uint32_t freqProcessor;
    uint32_t freqVCOHz;
    uint32_t freqVCOMhz;    /* in MHz                          */
    uint32_t pciClkSync;    /* PCI clock is synchronous        */
    uint32_t pciIntArbEn;    /* Internal PCI arbiter is enabled */
    uint32_t pllExtBusDiv;
    uint32_t pllFbkDiv;
    uint32_t pllFwdDiv;
    uint32_t pllFwdDivA;
    uint32_t pllFwdDivB;
...
static inline uint32_t get_mcsr(void)
{
    uint32_t val;
...
static inline void set_mcsr(uint32_t val)
{
