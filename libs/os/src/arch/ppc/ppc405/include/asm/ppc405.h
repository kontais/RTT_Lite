...
#define   SDR0_CUST0_NDFC_BP_ENCODE(n) ((((uint32_t)(n))&0xF)<<24)
#define   SDR0_CUST0_NDFC_BP_DECODE(n) ((((uint32_t)(n))>>24)&0x0F)

#define   SDR0_CUST0_NDFC_BAC_MASK    0x00C00000     /* NDFC Boot Address Cycle */
#define   SDR0_CUST0_NDFC_BAC_ENCODE(n) ((((uint32_t)(n))&0x3)<<22)
#define   SDR0_CUST0_NDFC_BAC_DECODE(n) ((((uint32_t)(n))>>22)&0x03)
...
#define   SDR0_CUST0_NDRSC_ENCODE(n) ((((uint32_t)(n))&0xFFF)<<4)
#define   SDR0_CUST0_NDRSC_DECODE(n) ((((uint32_t)(n))>>4)&0xFFF)
