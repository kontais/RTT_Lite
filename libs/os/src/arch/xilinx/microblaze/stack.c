    ...
    uint8_t *stack_addr, void *texit)
{
    ...
    *stk-- = 0;                                /* r18 */
    *stk-- = 0;                                /* r17 */
    *stk-- = (uint32_t)texit - 8;        /* r15 = task return address*/
    *stk-- = (uint32_t)tentry;        /* r14 = entry address*/
    *stk-- = (uint32_t)&_SDA_BASE_;    /* r13 */
    *stk-- = 0;                                /* r12 */
    *stk-- = 0;                                /* r11 */
    *stk-- = 0;                                /* r10 */
    *stk-- = 0;                                /* r09 */
    ...
    *stk-- = 0;                                /* r07 */
    *stk-- = 0;                                /* r06 */
    *stk-- = (uint32_t) parameter;    /* r05 */
    *stk-- = 0;                                /* r04 */
    *stk-- = 0;                                /* r03 */
    *stk-- = (uint32_t)&_SDA2_BASE_;    /* r02 */
