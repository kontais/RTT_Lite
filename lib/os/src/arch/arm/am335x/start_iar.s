...
;
        ...
        EXTERN  os_arch_trap_udef
        EXTERN  os_arch_trap_swi
        EXTERN  os_arch_trap_pabt
        EXTERN  os_arch_trap_dabt
        EXTERN  os_arch_trap_fiq
        EXTERN  os_arch_trap_irq
        EXTERN  os_isr_enter
        EXTERN  os_isr_leave
        EXTERN  interrupt_switch_flag
...
IRQ_Handler:
        ...
        LDR     r1, [r0]
        CMP     r1, #1
        BEQ     os_arch_context_switch_interrupt_do
...
os_arch_context_switch_interrupt_do:
        ...
        MRS     r0,  spsr       ; get cpsr of interrupt task
        ...
        LDMFD   r1,  {r1-r3}    ; restore r0-r2 of the interrupt task
        STMFD   sp!, {r1-r3}    ; push old task's r0-r2
        STMFD   sp!, {r0}       ; push old task's cpsr

        LDR     r4,  =interrupt_switch_task_from
        LDR     r5,  [r4]
        STR     sp,  [r5]       ; store sp in preempted tasks's TCB

        LDR     r6,  =interrupt_switch_task_to
        LDR     r6,  [r6]
