...
volatile uint32_t MMUTable[4*1024] SECTION("mmu_tbl") __attribute__((aligned(16*1024)));
...
void os_arch_mmu_init(void)
{
    ...
    os_arch_mmu_setmtt((uint32_t)&__text_start, 0x20000000-1,
                     0x1ff00000, RW_CB);
    /* PL region */
    os_arch_mmu_setmtt(0x40000000, 0xBFFFFFFF, 0x40000000, RW_NCNBXN);
    /* IOP registers */
    os_arch_mmu_setmtt(0xE0000000, 0xE02FFFFF, 0xE0000000, RW_NCNBXN);
    ...
    os_arch_mmu_setmtt(0xF8000000, 0xF8FFFFFF, 0xF8000000, RW_NCNBXN);
